...
- API duy nhất cho **hai** frontend: `../thuankydieu-frontend` (khách, port dev 3000) và `../thuankydieu-frontend-admin` (quản trị, port dev 3002).
...
22. Dev chạy port **3001**: đặt env `PORT=3001` (main.ts của Nest đã đọc `process.env.PORT`). Bật CORS chỉ cho origin của HAI frontend (dev: 3000 khách, 3002 admin).
